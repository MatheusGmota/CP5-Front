    ...
    <main className="flex justify-center content-center h-screen p-20">
      <section>
        ...
        <article className="flex justify-between items-center max-w-6xl gap-10 p-10">
          ...
          <Image src="https://images-assets.nasa.gov/image/GSFC_20171208_Archive_e001894/GSFC_20171208_Archive_e001894~orig.jpg" alt="Imagem Ilustrativa da Pagina de Conclusão do Livro" width={200} height={50}/>
        </article>
