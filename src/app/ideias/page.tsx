      ...
      <main className="flex justify-center content-center h-screen p-20">
        <section>
          ...
          <article className="flex justify-between items-center max-w-6xl gap-10 p-10">
            ...
            <Image src="http://images-assets.nasa.gov/image/PIA23791/PIA23791~orig.jpg" width={350} height={150} alt="Imagem do Planeta Vênus"></Image>
          </article>

          <article className="flex justify-between items-center max-w-6xl gap-10 p-10">
            <Image src="http://images-assets.nasa.gov/image/PIA01324/PIA01324~orig.jpg" width={350} height={150} alt="Imagem do Planeta Júpiter"></Image>
          ...
          <article className="flex justify-between items-center max-w-6xl gap-10 p-10">
            ...
            <Image src="https://images-assets.nasa.gov/image/PIA00232/PIA00232~orig.jpg" width={350} height={150} alt=""></Image>
          </article>
